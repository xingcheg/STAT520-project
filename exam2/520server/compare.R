...
M4 <- CFM(method = 4, para="mu")
L4 <- CFM(method = 4, para="lambda")
M5 <- CFM(method = 5, para="mu")
L5 <- CFM(method = 5, para="lambda")
M6 <- CFM(method = 6, para="mu")
L6 <- CFM(method = 6, para="lambda")


output <- list(M1 = M1, L1 = L1,
               M2 = M2, L2 = L2,
               M3 = M3, L3 = L3,
               M4 = M4, L4 = L4,
               M5 = M5, L5 = L5,
